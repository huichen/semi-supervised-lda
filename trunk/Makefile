...
all: lda infer estc mpi_lda mpi_estc_lda


clean:
	rm -f *.o
	rm -f lda mpi_lda infer estc mpi_estc_lda
...
estc: infer.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o
	$(CC) $(CFLAGS) estc.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o -o estc
...
mpi_estc_lda: mpi_estc_lda.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o
	$(MPICC) $(CFLAGS) mpi_estc_lda.cc cmd_flags.o common.o document.o model.o accumulative_model.o sampler.o -o mpi_estc_lda
